FROM nvcr.io/nvidia/pytorch:23.10-py3
  ...
  RUN (groupadd -g 748400513 gkoren || true) && useradd --uid 1776637669 -g 748400513 --no-log-init --create-home gkoren && (echo "gkoren:password" | chpasswd) && (echo "gkoren ALL=(ALL) NOPASSWD: ALL" >> /etc/sudoers)
